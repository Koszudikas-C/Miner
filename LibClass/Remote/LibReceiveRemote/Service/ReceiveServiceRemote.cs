...
using LibHandlerRemote.Service;
using LibReceiveRemote.Entities;
using LibReceiveRemote.Entities.Enum;
using LibReceiveRemote.Interface;

namespace LibReceiveRemote.Service;

public class ReceiveServiceRemote : IReceive
{
    private readonly ManagerTypeEventBus _managerTypeEventBusRemote = new();

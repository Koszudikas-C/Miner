...
namespace LibManagerFileRemote.Entities;
...
public class ConfigSaveFile
{
    ...
    public List<FileAttributes> TypeFileAttributes { get; set; } = [FileAttributes.Normal];
    public List<UnixFileMode> TypeFileUnixModes { get; set; } = [UnixFileMode.UserRead,
